...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"support svelte-1b99y99"}"><a href="${"https://ko-fi.com/C0C7BRLF8"}" target="${"_blank"}" class="${"svelte-1b99y99"}"><img height="${"36"}" style="${"border:0px;height:36px;"}" src="${"https://cdn.ko-fi.com/cdn/kofi2.png?v=3"}" border="${"0"}" alt="${"Buy Me a Coffee at ko-fi.com"}"></a></div>
</div>`;
});
function cubicOut(t) {
  const f = t - 1;
...
const css$1 = {
  code: ':root{--z-bottom:-100;--z-middle:0;--z-top:100;--z-overlay:1000;--border-radius:4px;--font-body:var(--serif);--font-form:var(--serif);--color-bg:#ffffff;--color-fg:var(--color-off-black);--color-placeholder:var(--color-gray-dark);--color-link:var(--color-purple);--color-focus:transparent;--color-form-bg:var(--color-gray-dark);--color-form-fg:var(--color-off-black);--color-border:var(--color-gray-light);--color-selection:var(--color-gray-light);--color-highlight:var(--color-yellow);--c-white:#fff;--c-gray:#dfdfdf;--c-green:#77e323;--c-darkgray:#42453d;--c-black:#000000;--c-green-15:rgba(119, 227, 35, 0.15)\n  --scale-0: 1rem;--scale-1:1.125rem;--scale-2:1.25rem;--scale-3:1.5rem;--scale-4:1.875rem;--scale-5:2.25rem;--scale-6:3rem;--scale-7:3.75rem;--scale-8:4.5rem;--scale-9:6rem;--scale-10:8rem;--scale-000:0.75rem;--scale-00:0.875rem;--weight-light:300;--weight-regular:400;--weight-medium:500;--weight-semibold:600;--weight-bold:700;--weight-extrabold:800;--weight-black:900;--line-none:1;--line-xs:1.125;--line-sm:1.275;--line-md:1.5;--line-lg:1.625;--line-xl:2;--letter-xs:-0.05em;--letter-sm:-0.025em;--letter-none:0em;--letter-lg:0.025em;--letter-xl:0.05em;--prose-xs:45ch;--prose-sm:55ch;--prose-md:65ch;--prose-lg:75ch;--prose-xl:85ch;--size-1:4px;--size-2:8px;--size-3:12px;--size-4:16px;--size-5:20px;--size-6:24px;--size-7:28px;--size-8:32px;--size-9:36px;--size-10:40px;--size-11:44px;--size-12:48px;--size-14:56px;--size-16:64px;--size-20:80px;--size-24:96px;--size-28:112px;--size-32:128px;--size-36:144px;--size-40:160px;--size-44:176px;--size-48:192px;--size-52:208px;--size-56:224px;--size-60:240px;--size-64:256px;--size-72:288px;--size-80:320px;--size-96:384px;--size-px:1px;--size-full:100%;--size-screen:100vw;--size-min:min-content;--size-max:max-content;--width-xs:480px;--width-sm:640px;--width-md:768px;--width-lg:1024px;--width-xl:1280px;--radius-100:100%;--radius-xs:3px;--radius-sm:6px;--radius-md:8px;--radius-lg:12px;--radius-xl:16px;--radius-full:9999px;--blur-xs:blur(4px);--blur-sm:blur(8px);--blur-md:blur(16px);--blur-lg:blur(24px);--blur-xl:blur(40px);--layer-1:10;--layer-2:20;--layer-3:30;--layer-4:40;--layer-5:50;--layer-below:-1;--layer-top:2147483647;--elevation-1:0 1px 2px 0 rgba(0, 0, 0, 0.05);--elevation-2:0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06);--elevation-3:0 4px 6px -2px rgba(0, 0, 0, 0.1),\n    0 2px 4px -2px rgba(0, 0, 0, 0.06);--elevation-4:0 12px 16px -4px rgba(0, 0, 0, 0.1),\n    0 4px 6px -2px rgba(0, 0, 0, 0.05);--elevation-5:0 20px 24px -4px rgba(0, 0, 0, 0.1),\n    0 8px 8px -4px rgba(0, 0, 0, 0.04);--elevation-6:0 24px 48px -12px rgba(0, 0, 0, 0.25);--elevation-7:0 32px 64px -12px rgba(0, 0, 0, 0.2);--easing-standard:cubic-bezier(0.4, 0, 0.2, 1);--easing-accelerate:cubic-bezier(0.4, 0, 1, 1);--easing-decelerate:cubic-bezier(0, 0, 0.2, 1);--color-grey-50:#f9fafb;--color-grey-100:#f2f4f5;--color-grey-200:#e8eaed;--color-grey-300:#d4d7dd;--color-grey-400:#a5aab4;--color-grey-500:#767c89;--color-grey-600:#555d6e;--color-grey-700:#3f4754;--color-grey-800:#2c343f;--color-grey-900:#10181c;--color-black:#14141b;--color-grey:var(--color-grey-500);--color-red-300:#fc8181;--color-red-500:#e53e3e;--color-red-700:#c53030;--color-red:var(--color-red-500);--color-green-300:#9ae6b4;--color-green-500:#48bb78;--color-green-700:#2f855a;--color-green:var(--color-green-500);--color-blue-300:#63b3ed;--color-blue-500:#4299e1;--color-blue-700:#3182ce;--color-blue:var(--color-blue-500);--color-pink-300:#fbb6ce;--color-pink-500:#ed64a6;--color-pink-700:#d53f8c;--color-pink:var(--color-pink-500);--color-purple-300:#b794f4;--color-purple-500:#805ad5;--color-purple-700:#6b46c1;--color-purple:var(--color-purple-500);--color-teal-300:#81e6d9;--color-teal-500:#38b2ac;--color-teal-700:#2c7a7b;--color-teal:var(--color-teal-500);--color-yellow-300:#faf089;--color-yellow-500:#ecc94b;--color-yellow-700:#d69e2e;--color-yellow:var(--color-yellow-500);--color-orange-300:#fbd38d;--color-orange-500:#ed8936;--color-orange-700:#dd6b20;--color-orange:var(--color-orange-500);--color-brown-300:#a1887f;--color-brown-500:#795548;--color-brown-700:#5d4037;--color-brown:var(--color-brown-500);--grid-2:repeat(2, minmax(0, 1fr));--grid-3:repeat(3, minmax(0, 1fr));--grid-4:repeat(4, minmax(0, 1fr));--grid-5:repeat(5, minmax(0, 1fr));--grid-6:repeat(6, minmax(0, 1fr));--grid-7:repeat(7, minmax(0, 1fr));--grid-8:repeat(8, minmax(0, 1fr));--grid-9:repeat(9, minmax(0, 1fr));--grid-10:repeat(10, minmax(0, 1fr));--grid-11:repeat(11, minmax(0, 1fr));--grid-12:repeat(12, minmax(0, 1fr));--grid-page-width:var(--width-xl);--grid-page-gutter:5vw;--grid-page-main:2 / 3;--grid-page:minmax(var(--grid-page-gutter), 1fr)\n    minmax(0, var(--grid-page-width)) minmax(var(--grid-page-gutter), 1fr)}.container.svelte-1bf86z1.svelte-1bf86z1{z-index:16;height:90px;width:100%}.container.svelte-1bf86z1 .header-grid.svelte-1bf86z1{display:grid;background-color:var(--c-darkgray);grid-template-areas:"hl hc hr" "tb tb tb";height:90px;grid-template-rows:60px auto;display:intital}@media(max-width: 800px){.container.svelte-1bf86z1 .header-grid.svelte-1bf86z1{grid-template-columns:minmax(120px, 200px) auto minmax(120px, 200px)}}@media(min-width: 800px){.container.svelte-1bf86z1 .header-grid.svelte-1bf86z1{grid-template-columns:minmax(240px, 280px) auto minmax(200px, 300px);grid-template-areas:"hl hc hr";grid-template-rows:60px;height:60px}}@media(min-width: 1000px){.container.svelte-1bf86z1 .header-grid.svelte-1bf86z1{grid-template-columns:250px auto 300px;height:60px}}.container.svelte-1bf86z1 .header-grid .toolbar.svelte-1bf86z1{height:40px;align-self:start;position:relative;top:0px;z-index:10;grid-area:tb;background-color:var(--c-darkgray);width:100%;transition:all 0.3s}.container.svelte-1bf86z1 .header-grid .toolbar.fixed.svelte-1bf86z1{position:fixed}.container.svelte-1bf86z1 .header-grid .toolbar.expanded.svelte-1bf86z1{height:80vh;border-bottom:3px solid var(--c-green)}.container.svelte-1bf86z1 .header-grid .header-left.svelte-1bf86z1{grid-area:"hl";align-content:center;padding-left:10px;display:flex}.container.svelte-1bf86z1 .header-grid .header-centre.svelte-1bf86z1{grid-area:"hc"}.container.svelte-1bf86z1 .header-grid .header-right.svelte-1bf86z1{grid-area:"hr";align-content:center;display:flex;justify-content:end;padding-right:20px}.container.svelte-1bf86z1 .header-grid .header-right a.svelte-1bf86z1{margin-top:12px}',
  map: null
};
const TopNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_showHideMenu();
  $$unsubscribe_scrollY();
  return `<div class="${"container svelte-1bf86z1"}"><div class="${"header-grid svelte-1bf86z1"}"><div class="${"header-left svelte-1bf86z1"}">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}</div>
    <div class="${"header-centre svelte-1bf86z1"}"></div>
    <div class="${"header-right svelte-1bf86z1"}">
      <a href="${"https://ko-fi.com/C0C7BRLF8"}" target="${"_blank"}" class="${"svelte-1bf86z1"}"><img height="${"36"}" style="${"border:0px;height:36px;"}" src="${"https://cdn.ko-fi.com/cdn/kofi2.png?v=3"}" border="${"0"}" alt="${"Buy Me a Coffee at ko-fi.com"}"></a>
      </div>

    ${loadSecondary ? `<div class="${[
    "toolbar svelte-1bf86z1",
...
const css = {
  code: ':root{--z-bottom:-100;--z-middle:0;--z-top:100;--z-overlay:1000;--border-radius:4px;--font-body:var(--serif);--font-form:var(--serif);--color-bg:#ffffff;--color-fg:var(--color-off-black);--color-placeholder:var(--color-gray-dark);--color-link:var(--color-purple);--color-focus:transparent;--color-form-bg:var(--color-gray-dark);--color-form-fg:var(--color-off-black);--color-border:var(--color-gray-light);--color-selection:var(--color-gray-light);--color-highlight:var(--color-yellow);--c-white:#fff;--c-gray:#dfdfdf;--c-green:#77e323;--c-darkgray:#42453d;--c-black:#000000;--c-green-15:rgba(119, 227, 35, 0.15)\n  --scale-0: 1rem;--scale-1:1.125rem;--scale-2:1.25rem;--scale-3:1.5rem;--scale-4:1.875rem;--scale-5:2.25rem;--scale-6:3rem;--scale-7:3.75rem;--scale-8:4.5rem;--scale-9:6rem;--scale-10:8rem;--scale-000:0.75rem;--scale-00:0.875rem;--weight-light:300;--weight-regular:400;--weight-medium:500;--weight-semibold:600;--weight-bold:700;--weight-extrabold:800;--weight-black:900;--line-none:1;--line-xs:1.125;--line-sm:1.275;--line-md:1.5;--line-lg:1.625;--line-xl:2;--letter-xs:-0.05em;--letter-sm:-0.025em;--letter-none:0em;--letter-lg:0.025em;--letter-xl:0.05em;--prose-xs:45ch;--prose-sm:55ch;--prose-md:65ch;--prose-lg:75ch;--prose-xl:85ch;--size-1:4px;--size-2:8px;--size-3:12px;--size-4:16px;--size-5:20px;--size-6:24px;--size-7:28px;--size-8:32px;--size-9:36px;--size-10:40px;--size-11:44px;--size-12:48px;--size-14:56px;--size-16:64px;--size-20:80px;--size-24:96px;--size-28:112px;--size-32:128px;--size-36:144px;--size-40:160px;--size-44:176px;--size-48:192px;--size-52:208px;--size-56:224px;--size-60:240px;--size-64:256px;--size-72:288px;--size-80:320px;--size-96:384px;--size-px:1px;--size-full:100%;--size-screen:100vw;--size-min:min-content;--size-max:max-content;--width-xs:480px;--width-sm:640px;--width-md:768px;--width-lg:1024px;--width-xl:1280px;--radius-100:100%;--radius-xs:3px;--radius-sm:6px;--radius-md:8px;--radius-lg:12px;--radius-xl:16px;--radius-full:9999px;--blur-xs:blur(4px);--blur-sm:blur(8px);--blur-md:blur(16px);--blur-lg:blur(24px);--blur-xl:blur(40px);--layer-1:10;--layer-2:20;--layer-3:30;--layer-4:40;--layer-5:50;--layer-below:-1;--layer-top:2147483647;--elevation-1:0 1px 2px 0 rgba(0, 0, 0, 0.05);--elevation-2:0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06);--elevation-3:0 4px 6px -2px rgba(0, 0, 0, 0.1),\n    0 2px 4px -2px rgba(0, 0, 0, 0.06);--elevation-4:0 12px 16px -4px rgba(0, 0, 0, 0.1),\n    0 4px 6px -2px rgba(0, 0, 0, 0.05);--elevation-5:0 20px 24px -4px rgba(0, 0, 0, 0.1),\n    0 8px 8px -4px rgba(0, 0, 0, 0.04);--elevation-6:0 24px 48px -12px rgba(0, 0, 0, 0.25);--elevation-7:0 32px 64px -12px rgba(0, 0, 0, 0.2);--easing-standard:cubic-bezier(0.4, 0, 0.2, 1);--easing-accelerate:cubic-bezier(0.4, 0, 1, 1);--easing-decelerate:cubic-bezier(0, 0, 0.2, 1);--color-grey-50:#f9fafb;--color-grey-100:#f2f4f5;--color-grey-200:#e8eaed;--color-grey-300:#d4d7dd;--color-grey-400:#a5aab4;--color-grey-500:#767c89;--color-grey-600:#555d6e;--color-grey-700:#3f4754;--color-grey-800:#2c343f;--color-grey-900:#10181c;--color-black:#14141b;--color-grey:var(--color-grey-500);--color-red-300:#fc8181;--color-red-500:#e53e3e;--color-red-700:#c53030;--color-red:var(--color-red-500);--color-green-300:#9ae6b4;--color-green-500:#48bb78;--color-green-700:#2f855a;--color-green:var(--color-green-500);--color-blue-300:#63b3ed;--color-blue-500:#4299e1;--color-blue-700:#3182ce;--color-blue:var(--color-blue-500);--color-pink-300:#fbb6ce;--color-pink-500:#ed64a6;--color-pink-700:#d53f8c;--color-pink:var(--color-pink-500);--color-purple-300:#b794f4;--color-purple-500:#805ad5;--color-purple-700:#6b46c1;--color-purple:var(--color-purple-500);--color-teal-300:#81e6d9;--color-teal-500:#38b2ac;--color-teal-700:#2c7a7b;--color-teal:var(--color-teal-500);--color-yellow-300:#faf089;--color-yellow-500:#ecc94b;--color-yellow-700:#d69e2e;--color-yellow:var(--color-yellow-500);--color-orange-300:#fbd38d;--color-orange-500:#ed8936;--color-orange-700:#dd6b20;--color-orange:var(--color-orange-500);--color-brown-300:#a1887f;--color-brown-500:#795548;--color-brown-700:#5d4037;--color-brown:var(--color-brown-500);--grid-2:repeat(2, minmax(0, 1fr));--grid-3:repeat(3, minmax(0, 1fr));--grid-4:repeat(4, minmax(0, 1fr));--grid-5:repeat(5, minmax(0, 1fr));--grid-6:repeat(6, minmax(0, 1fr));--grid-7:repeat(7, minmax(0, 1fr));--grid-8:repeat(8, minmax(0, 1fr));--grid-9:repeat(9, minmax(0, 1fr));--grid-10:repeat(10, minmax(0, 1fr));--grid-11:repeat(11, minmax(0, 1fr));--grid-12:repeat(12, minmax(0, 1fr));--grid-page-width:var(--width-xl);--grid-page-gutter:5vw;--grid-page-main:2 / 3;--grid-page:minmax(var(--grid-page-gutter), 1fr)\n    minmax(0, var(--grid-page-width)) minmax(var(--grid-page-gutter), 1fr)}@font-face{font-family:"Consola";font-style:normal;font-weight:400;src:local(""), url("/fonts/CONSOLA.ttf") format("truetype")}.svelte-n7sbha.svelte-n7sbha{font-family:"Consola"}a{color:var(--c-darkgray);transition:background 0.3s;background:linear-gradient(180deg, transparent 85%, rgba(119, 227, 35, 0.15) 15%)}a:focus{color:var(--c-darkgray);background:linear-gradient(180deg, transparent 80%, rgba(119, 227, 35, 0.35) 20%)}a:hover{background:rgba(119, 227, 35, 0.35)}.grid.svelte-n7sbha.svelte-n7sbha{max-width:1200px;margin:0 auto;display:grid;background-size:20px 20px;background-image:linear-gradient(to right, rgba(0, 0, 0, 0.02) 1px, transparent 1px), linear-gradient(to bottom, rgba(0, 0, 0, 0.02) 1px, transparent 1px)}@media(min-width: 800px){.grid.svelte-n7sbha.svelte-n7sbha{grid-template-columns:minmax(240px, 280px) minmax(600px, 700px) 1px}}@media(min-width: 1000px){.grid.svelte-n7sbha.svelte-n7sbha{grid-template-columns:250px 700px 300px}}@media(max-width: 600px){.grid.svelte-n7sbha.svelte-n7sbha{grid-template-columns:1px auto 1px}}.grid.svelte-n7sbha .sidebar-left.svelte-n7sbha{background:linear-gradient(to top right, rgba(255, 255, 255, 0.2) 80%, rgba(0, 0, 0, 0.05))}.grid.svelte-n7sbha .sidebar-right.svelte-n7sbha{background:linear-gradient(to top left, rgba(255, 255, 255, 0.2) 80%, rgba(0, 0, 0, 0.05))}.grid.svelte-n7sbha header.svelte-n7sbha{width:100%;height:90px}header.svelte-n7sbha.svelte-n7sbha,footer.svelte-n7sbha.svelte-n7sbha{grid-column:1/4}@media all and (max-width: 600px){aside.svelte-n7sbha.svelte-n7sbha,article.svelte-n7sbha.svelte-n7sbha{grid-column:1/4}}header.svelte-n7sbha.svelte-n7sbha,aside.svelte-n7sbha.svelte-n7sbha,article.svelte-n7sbha.svelte-n7sbha,footer.svelte-n7sbha.svelte-n7sbha{display:flex;justify-content:center}article.svelte-n7sbha.svelte-n7sbha{padding:10px 20px}#content.svelte-n7sbha.svelte-n7sbha{position:relative;max-width:90vw}',
  map: null
};
...
<div class="${"grid svelte-n7sbha"}"><header class="${"svelte-n7sbha"}">${validate_component(TopNav, "TopNav").$$render($$result, { sidebarData }, {}, {})}</header>

  ${$innerWidth > 800 ? `<aside class="${"sidebar-left svelte-n7sbha"}">${$tableOfContents.length ? `${validate_component(SideNavbar, "SideNavbar").$$render($$result, { sidebarData }, {}, {
    default: () => {
      return `${validate_component(InThisArticle, "InThisArticle").$$render($$result, { tableOfContents: $tableOfContents }, {}, {})}`;
    }
  })}` : ``}</aside>` : `<div class="${"svelte-n7sbha"}"></div>`}

  <article class="${"svelte-n7sbha"}"><main id="${"content"}" class="${"svelte-n7sbha"}">${slots.default ? slots.default({}) : ``}</main></article>

  <aside class="${"sidebar-right svelte-n7sbha"}">${$tableOfContents.length && $innerWidth >= 1200 ? `${validate_component(InThisArticle, "InThisArticle").$$render($$result, { tableOfContents: $tableOfContents }, {}, {})}
      ` : ``}</aside>
  <footer class="${"svelte-n7sbha"}">${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</footer>
</div>`;
});
