...
const Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a${add_attribute("href", data.href, 0)} class="${"card svelte-r5pton"}"><p class="${"card-title svelte-r5pton"}">${escape(keyToSentence(data.id))}</p>

  <p class="${"card-desc svelte-r5pton"}">${escape(data.desc)}</p>
