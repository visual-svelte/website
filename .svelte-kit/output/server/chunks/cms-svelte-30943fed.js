...
const css = {
  code: ':root{--z-bottom:-100;--z-middle:0;--z-top:100;--z-overlay:1000;--border-radius:4px;--font-body:var(--serif);--font-form:var(--serif);--color-bg:#ffffff;--color-fg:var(--color-off-black);--color-placeholder:var(--color-gray-dark);--color-link:var(--color-purple);--color-focus:transparent;--color-form-bg:var(--color-gray-dark);--color-form-fg:var(--color-off-black);--color-border:var(--color-gray-light);--color-selection:var(--color-gray-light);--color-highlight:var(--color-yellow);--c-white:#fff;--c-gray:#dfdfdf;--c-green:#77e323;--c-darkgray:#42453d;--c-black:#000000;--c-green-15:rgba(119, 227, 35, 0.15)}.container.svelte-1ly4bem.svelte-1ly4bem{height:300px;width:400px;position:relative;background-image:url("images/migrants/migrants.jpg");background-size:cover;background-blend-mode:saturation}.container.svelte-1ly4bem .title.svelte-1ly4bem{height:40px;text-align:center;color:white}.container.svelte-1ly4bem .title h4.svelte-1ly4bem,.container.svelte-1ly4bem .title p.svelte-1ly4bem{padding:2px 10px;margin:10px 0px 0px 0px;background-color:purple;display:inline-block}.container.svelte-1ly4bem .title h4.svelte-1ly4bem{max-height:16px;overflow:hidden}.container.svelte-1ly4bem .title p.svelte-1ly4bem{font-size:0.7rem;line-height:0.7rem}.container.svelte-1ly4bem .chart-area.svelte-1ly4bem{background-color:rgba(255, 255, 255, 0.05);height:150px;width:200px;margin:50px 100px;position:relative}.container.svelte-1ly4bem .chart-area .bottom-axis.svelte-1ly4bem{border-bottom:1px solid white;height:150px;width:100%;position:absolute}.container.svelte-1ly4bem .chart-area .bar-container.svelte-1ly4bem{height:160px;width:200px;top:-10px;position:absolute;overflow-y:hidden}.container.svelte-1ly4bem .chart-area .bar-container .bar.svelte-1ly4bem{background-color:#107ddb;opacity:0.8;width:30px;bottom:0px;position:absolute}.container.svelte-1ly4bem .chart-area .bar-container .bar .barLabel.svelte-1ly4bem{position:absolute;top:-30px;width:30px;text-align:center;font-size:0.6rem;color:white}.container.svelte-1ly4bem .chart-area .grid-line.svelte-1ly4bem{position:absolute;width:100%;border-top:1px dashed rgba(255, 255, 255, 0.3)}.container.svelte-1ly4bem .chart-area .grid-line .yAxisLabel.svelte-1ly4bem{position:absolute;color:white;font-size:0.6rem;width:30px;left:-35px;top:-22px;text-align:end}.container.svelte-1ly4bem .xLabels.svelte-1ly4bem{position:absolute;color:white;top:150px;display:flex;font-size:0.6rem}.container.svelte-1ly4bem .xLabels .xAxisLabel.svelte-1ly4bem{padding:5px 15px 5px 16px}.container.svelte-1ly4bem .toggle-button.svelte-1ly4bem{background-color:rgba(255, 255, 255, 0);color:white;bottom:0px;width:80px;margin:10px;cursor:pointer;border:1px solid white;border-radius:30px;padding:10px 10px;position:absolute;transition:background-color 0.4s}.container.svelte-1ly4bem .toggle-button.svelte-1ly4bem:hover{background-color:rgba(255, 255, 255, 0.2)}',
  map: null
};
const ChartEntry = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"container svelte-1ly4bem"}"><button class="${"toggle-button svelte-1ly4bem"}">Play </button>
  ${``}
</div>`;
});
let cmsSvelte = [
