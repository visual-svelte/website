import { c as create_ssr_component, g as subscribe, b as each, v as validate_component } from "./index-02532eaa.js";
import { S as SimplePostCard } from "./SimplePostCard-778ec895.js";
import { p as page } from "./stores-9fa16f27.js";
/* empty css                                                    */const css = {
...
const PostGallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="${"post-gallery svelte-1vfdyqd"}">${each(filtered, (post) => {
