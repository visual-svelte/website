...
let svg_width$4 = 400;
const AxisSimple = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let height2;
  let width2;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", svg_width$4, 0)}${(0, import_index_02532eaa.a)("height", svg_height$4, 0)}><g class="${"xAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$a) + "," + (0, import_index_02532eaa.e)(margin$a + height2) + ")"}"${(0, import_index_02532eaa.a)("this", pinXAxis, 0)}></g><g class="${"yAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$a) + "," + (0, import_index_02532eaa.e)(margin$a) + ")"}"${(0, import_index_02532eaa.a)("this", pinYAxis, 0)}></g></svg>`;
});
let margin$9 = 30;
let svg_height$3 = 300;
let svg_width$3 = 400;
const AxisLog = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let height2;
  let width2;
  let pinXAxis, pinYAxis;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", svg_width$3, 0)}${(0, import_index_02532eaa.a)("height", svg_height$3, 0)}><g class="${"xAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$9) + "," + (0, import_index_02532eaa.e)(margin$9 + height2) + ")"}"${(0, import_index_02532eaa.a)("this", pinXAxis, 0)}></g><g class="${"yAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$9) + "," + (0, import_index_02532eaa.e)(margin$9) + ")"}"${(0, import_index_02532eaa.a)("this", pinYAxis, 0)}></g></svg>`;
});
let margin$8 = 30;
let svg_height$2 = 300;
let svg_width$2 = 400;
const AxisScalePoint = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let height2;
  let width2;
  let x;
  let pinXAxis;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", svg_width$2, 0)}${(0, import_index_02532eaa.a)("height", svg_height$2, 0)}><g class="${"xAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$8) + ", " + (0, import_index_02532eaa.e)(height2 - margin$8) + ")"}"${(0, import_index_02532eaa.a)("this", pinXAxis, 0)}></g><circle${(0, import_index_02532eaa.a)("cx", x("Banana") + margin$8, 0)}${(0, import_index_02532eaa.a)("cy", height2 / 2, 0)}${(0, import_index_02532eaa.a)("r", 8, 0)}></circle></svg>`;
});
let margin$7 = 30;
let svg_height$1 = 300;
let svg_width$1 = 400;
const AxisScaleBand = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let height2;
  let width2;
  let x;
  let pinXAxis;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", svg_width$1, 0)}${(0, import_index_02532eaa.a)("height", svg_height$1, 0)}><g class="${"xAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$7) + "," + (0, import_index_02532eaa.e)(margin$7 + height2) + ")"}"${(0, import_index_02532eaa.a)("this", pinXAxis, 0)}></g><rect${(0, import_index_02532eaa.a)("x", margin$7 + x("Cherry"), 0)}${(0, import_index_02532eaa.a)("y", height2 + margin$7 - 50, 0)}${(0, import_index_02532eaa.a)("height", 50, 0)}${(0, import_index_02532eaa.a)("width", x.bandwidth(), 0)} fill="${"#69b3a2"}" opacity="${"0.5"}"></rect><rect${(0, import_index_02532eaa.a)("x", margin$7 + x("Banana"), 0)}${(0, import_index_02532eaa.a)("y", height2 + margin$7 - 150, 0)}${(0, import_index_02532eaa.a)("height", 150, 0)}${(0, import_index_02532eaa.a)("width", x.bandwidth(), 0)} fill="${"#453234"}" opacity="${"0.5"}"></rect></svg>`;
});
...
let svg_height = 300;
let svg_width = 400;
const AxisLabels = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let height2;
  let width2;
  let pinXAxis, pinYAxis;
  ...
  d3.scaleLinear().domain([0, 100]).range([0, width2]);
  d3.scaleLinear().domain([100, 0]).range([0, height2]);
  return `<svg${(0, import_index_02532eaa.a)("width", svg_width, 0)}${(0, import_index_02532eaa.a)("height", svg_height, 0)}><g class="${"xAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$6) + "," + (0, import_index_02532eaa.e)(margin$6 + height2) + ")"}"${(0, import_index_02532eaa.a)("this", pinXAxis, 0)}></g><g class="${"yAxis"}" transform="${"translate(" + (0, import_index_02532eaa.e)(margin$6) + "," + (0, import_index_02532eaa.e)(margin$6) + ")"}"${(0, import_index_02532eaa.a)("this", pinYAxis, 0)}></g><text class="${"axis-label svelte-5x56w4"}" fill="${"blue"}"${(0, import_index_02532eaa.a)("y", svg_height - 10, 0)}${(0, import_index_02532eaa.a)("x", width2 / 2, 0)}>X Axis Label
  </text><text class="${"axis-label svelte-5x56w4"}" fill="${"red"}"${(0, import_index_02532eaa.a)("y", 15, 0)}${(0, import_index_02532eaa.a)("x", -height2, 0)} transform="${"rotate(270)"}">Y Axis Label
  </text></svg>`;
});
...
let width$e = 400;
let height$e = 300;
const BrushXSimple = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let x;
  let rx;
  let ry;
  let data2;
...
<svg${(0, import_index_02532eaa.a)("width", width$e, 0)}${(0, import_index_02532eaa.a)("height", height$e, 0)}><g class="${"points"}">${(0, import_index_02532eaa.b)(data2, (point) => {
    return `<circle class="${(0, import_index_02532eaa.e)((0, import_index_02532eaa.n)(bounds[0] <= point && point <= bounds[1] ? "selected" : selectionMade ? "not-selected" : "")) + " svelte-na4awy"}"${(0, import_index_02532eaa.a)("cx", x(point), 0)}${(0, import_index_02532eaa.a)("cy", ry(), 0)}${(0, import_index_02532eaa.a)("r", 3, 0)}></circle>`;
  })}</g><g class="${"brush svelte-na4awy"}"${(0, import_index_02532eaa.a)("this", pinBrush, 0)}></g></svg>`;
});
...
function writable(value, start = import_index_02532eaa.d) {
  let stop;
  const subscribers = /* @__PURE__ */ new Set();
  function set(new_value) {
    if ((0, import_index_02532eaa.f)(value, new_value)) {
      value = new_value;
      if (stop) {
  ...
  function subscribe2(run, invalidate = import_index_02532eaa.d) {
    const subscriber = [run, invalidate];
    subscribers.add(subscriber);
    if (subscribers.size === 1) {
      stop = start(set) || import_index_02532eaa.d;
    }
    run(value);
    return () => {
...
let width$d = 400;
let height$d = 300;
const BrushStore = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let x;
  let $brushData, $$unsubscribe_brushData;
  let $filtered, $$unsubscribe_filtered;
  $$unsubscribe_brushData = (0, import_index_02532eaa.g)(brushData, (value) => $brushData = value);
  $$unsubscribe_filtered = (0, import_index_02532eaa.g)(filtered, (value) => $filtered = value);
  let pinBrush;
  let bounds = [0, 0];
  ...
  (0, import_index_02532eaa.h)(filtered, $filtered = $brushData.filter((d) => bounds[0] <= d[0] && d[0] <= bounds[1]), $filtered);
  $$unsubscribe_brushData();
  $$unsubscribe_filtered();
  return `<p>Original: ${(0, import_index_02532eaa.e)($brushData.length)}</p>
<p>Filtered: ${(0, import_index_02532eaa.e)($filtered.length)}</p>
<p>Bounds: ${(0, import_index_02532eaa.e)(bounds[0].toPrecision(4))}, ${(0, import_index_02532eaa.e)(bounds[1].toPrecision(4))}</p>
<svg width="${"400"}" height="${"500"}"><g class="${"circles svelte-1mqzxo2"}">${(0, import_index_02532eaa.b)($brushData, (point) => {
    return `<circle class="${[
      "circle svelte-1mqzxo2",
      bounds[0] <= point[0] && point[0] <= bounds[1] ? "selected" : ""
    ].join(" ").trim()}"${(0, import_index_02532eaa.a)("cy", point[1], 0)}${(0, import_index_02532eaa.a)("cx", x(point[0]), 0)} r="${"5"}"></circle>`;
  })}</g><g class="${"bars"}">${(0, import_index_02532eaa.b)($filtered, (bar) => {
    return `<rect class="${"bar svelte-1mqzxo2"}"${(0, import_index_02532eaa.a)("width", width$d / $brushData.length, 0)}${(0, import_index_02532eaa.a)("height", bar[1] / 2, 0)} style="${"transform:translate(" + (0, import_index_02532eaa.e)(bar[0]) + "px," + (0, import_index_02532eaa.e)(height$d + 100 - bar[1] / 2) + "px)"}"></rect>`;
  })}</g><g class="${"brush"}"${(0, import_index_02532eaa.a)("this", pinBrush, 0)}></g></svg>`;
});
let width$c = 600;
let height$c = 400;
const ChordBasic = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let viewBx;
  let outerRadius;
  let innerRadius;
  let chordGen;
  ...
  return `<svg${(0, import_index_02532eaa.a)("viewBox", viewBx, 0)}${(0, import_index_02532eaa.a)("width", width$c, 0)}${(0, import_index_02532eaa.a)("height", height$c, 0)}${(0, import_index_02532eaa.a)("this", svgHere, 0)}><g class="${"outer-arcs"}">${(0, import_index_02532eaa.b)(chords["groups"], (chord, i) => {
    return `<g class="${"outer"}"><path${(0, import_index_02532eaa.a)("fill", colors2[i], 0)}${(0, import_index_02532eaa.a)("d", arcGen(chord), 0)}></path></g>`;
  })}</g><g class="${"ribbons"}" style="${"fill-opacity:0.4;"}">${(0, import_index_02532eaa.b)(chords, (chord, i) => {
    return `<path style="${"mix-blend-mode: multiply;"}"${(0, import_index_02532eaa.a)("fill", colors2[chord.source.index], 0)} class="${"ribbon"}"${(0, import_index_02532eaa.a)("d", ribbonGen(chord), 0)}></path>`;
  })}</g></svg>`;
});
const data$1 = [
  [
...
let width$b = 600;
let height$b = 500;
const ChordComplex = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let viewBx;
  let outerRadius;
  let innerRadius;
  let chordGen;
  ...
  return `<svg${(0, import_index_02532eaa.a)("viewBox", viewBx, 0)}${(0, import_index_02532eaa.a)("width", width$b, 0)}${(0, import_index_02532eaa.a)("height", height$b, 0)}${(0, import_index_02532eaa.a)("this", svgHere, 0)}><g class="${"outer-arcs"}">${(0, import_index_02532eaa.b)(chords["groups"], (chord, i) => {
    return `<g class="${"group"}"><path${(0, import_index_02532eaa.a)("fill", colors[i], 0)}${(0, import_index_02532eaa.a)("d", arcGen(chord), 0)}></path><g>${(0, import_index_02532eaa.b)(ticks(chord), (tick, t) => {
      return `<g class="${"tick"}" style="${"transform:rotate(" + (0, import_index_02532eaa.e)(tick.angle * 180 / Math.PI - 90) + "deg) translate(" + (0, import_index_02532eaa.e)(outerRadius) + "px,0);"}">${t < 1 ? `<text${(0, import_index_02532eaa.a)("fill", colors[i], 0)} x="${"30"}" y="${"5"}" class="${"phone-title svelte-vwo2bq"}" font-weight="${"bold"}" style="${"transform:" + (0, import_index_02532eaa.e)(tick.angle > Math.PI ? "rotate(180deg) translate(-95px)" : null)}">${(0, import_index_02532eaa.e)(names[i])}</text>` : ``}<line${(0, import_index_02532eaa.a)("stroke", colors[i], 0)} x2="${"6"}"></line><text x="${"8"}" dy="${"0.35em"}" style="${"transform:" + (0, import_index_02532eaa.e)(tick.angle > Math.PI ? "rotate(180deg) translate(-16px)" : null)}"${(0, import_index_02532eaa.a)("text-anchor", tick.angle > Math.PI ? "end" : null, 0)}>${(0, import_index_02532eaa.e)(formatValue(tick.value))}</text></g>`;
    })}</g></g>`;
  })}</g><g class="${"ribbons"}" style="${"fill-opacity:0.4;"}">${(0, import_index_02532eaa.b)(chords, (chord, i) => {
    return `<path${(0, import_index_02532eaa.a)("fill", colors[chord.source.index], 0)} class="${"ribbon"}"${(0, import_index_02532eaa.a)("d", ribbonGen(chord), 0)}></path>`;
  })}</g></svg>`;
});
...
let width$a = 300;
let height$a = 300;
const ContourBasic = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let contourGen;
  let contours;
  let color;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", width$a, 0)}${(0, import_index_02532eaa.a)("height", height$a, 0)}>${(0, import_index_02532eaa.b)(contours, (contour) => {
    return `<path${(0, import_index_02532eaa.a)("fill", color(contour.value), 0)}${(0, import_index_02532eaa.a)("d", geoGen(contour), 0)}></path>`;
  })}</svg>`;
});
...
const DragSimple = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let left = 50;
  let top = 50;
  $$result.css.add(css$2);
  return `<div class="${"frame svelte-1pukr9r"}"><div style="${"left: " + (0, import_index_02532eaa.e)(left) + "px; top: " + (0, import_index_02532eaa.e)(top) + "px;"}" class="${"draggable svelte-1pukr9r"}">Drag me
  </div></div>
`;
});
const DragD3 = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let bindSvgHere;
  let circle;
  ...
  return `<svg height="${"300"}" width="${"500"}"${(0, import_index_02532eaa.a)("this", bindSvgHere, 0)}></svg>`;
});
const DragD3Svelte = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  ...
  d3.drag().on("drag", started);
  return `<svg height="${"300"}" width="${"500"}"${(0, import_index_02532eaa.a)("this", bindSvgHere, 0)}>${(0, import_index_02532eaa.b)(data2, (point, i) => {
    return `<circle class="${"myPoint"}"${(0, import_index_02532eaa.a)("cx", point[0], 0)}${(0, import_index_02532eaa.a)("cy", point[1], 0)} r="${"15"}"${(0, import_index_02532eaa.a)("fill", colors2[i], 0)}></circle>`;
  })}</svg>`;
});
let width$9 = 300;
let height$9 = 400;
const ForceSimple = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let nodes;
  const colourScale = d3.scaleOrdinal(d3.schemeCategory10);
  nodes = [].concat(d3.range(88).map(function() {
    return { r: d3.randomInt(5, 10)() };
  }));
  return `<svg${(0, import_index_02532eaa.a)("width", width$9, 0)}${(0, import_index_02532eaa.a)("height", height$9, 0)}><g class="${"points"}">${(0, import_index_02532eaa.b)(nodes, (point, i) => {
    return `<circle class="${"node"}"${(0, import_index_02532eaa.a)("r", point.r, 0)}${(0, import_index_02532eaa.a)("fill", colourScale(i), 0)}${(0, import_index_02532eaa.a)("cx", point.x, 0)}${(0, import_index_02532eaa.a)("cy", point.y, 0)}></circle>`;
  })}</g></svg>`;
});
let width$8 = 500;
let height$8 = 600;
const ForceRadial = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let nodes;
  let svg;
  nodes = [].concat(d3.range(88).map(function() {
    return { type: "a" };
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", width$8, 0)}${(0, import_index_02532eaa.a)("height", height$8, 0)}${(0, import_index_02532eaa.a)("this", svg, 0)}>${(0, import_index_02532eaa.b)(nodes, (point) => {
    return `<circle class="${"node"}"${(0, import_index_02532eaa.a)("r", 5, 0)}${(0, import_index_02532eaa.a)("fill", point.type == "a" ? "brown" : "steelblue", 0)}${(0, import_index_02532eaa.a)("cx", point.x, 0)}${(0, import_index_02532eaa.a)("cy", point.y, 0)}><title>${(0, import_index_02532eaa.e)(point.id)}</title></circle>`;
  })}</svg>`;
});
var graph = {
  nodes: [
...
const ForceFull = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let links;
  let nodes;
  let d32 = {
    zoom: import_d3_zoom.zoom,
    zoomIdentity: import_d3_zoom.zoomIdentity,
    scaleLinear: import_d3_scale.scaleLinear,
    scaleOrdinal: import_d3_scale.scaleOrdinal,
    schemeCategory10: import_d3_scale_chromatic.schemeCategory10,
    select: import_d3_selection.select,
    selectAll: import_d3_selection.selectAll,
    drag: import_d3_drag.drag,
    forceSimulation: import_d3_force.forceSimulation,
    forceLink: import_d3_force.forceLink,
    forceManyBody: import_d3_force.forceManyBody,
    forceCenter: import_d3_force.forceCenter
  };
  let svg;
  let width2 = 500;
  let height2 = 600;
...
<svg${(0, import_index_02532eaa.a)("width", width2, 0)}${(0, import_index_02532eaa.a)("height", height2, 0)} class="${"svelte-gf1wo9"}"${(0, import_index_02532eaa.a)("this", svg, 0)}>${(0, import_index_02532eaa.b)(links, (link) => {
    return `<g stroke="${"#999"}" stroke-opacity="${"0.6"}"><line${(0, import_index_02532eaa.a)("x1", link.source.x, 0)}${(0, import_index_02532eaa.a)("y1", link.source.y, 0)}${(0, import_index_02532eaa.a)("x2", link.target.x, 0)}${(0, import_index_02532eaa.a)("y2", link.target.y, 0)} transform="${"translate(" + (0, import_index_02532eaa.e)(transform.x) + " " + (0, import_index_02532eaa.e)(transform.y) + ") scale(" + (0, import_index_02532eaa.e)(transform.k) + " " + (0, import_index_02532eaa.e)(transform.k) + ")"}"><title>${(0, import_index_02532eaa.e)(link.source.id)}</title></line></g>`;
  })}${(0, import_index_02532eaa.b)(nodes, (point) => {
    return `<circle class="${"node svelte-gf1wo9"}" r="${"5"}"${(0, import_index_02532eaa.a)("fill", colourScale(point.group), 0)}${(0, import_index_02532eaa.a)("cx", point.x, 0)}${(0, import_index_02532eaa.a)("cy", point.y, 0)} transform="${"translate(" + (0, import_index_02532eaa.e)(transform.x) + " " + (0, import_index_02532eaa.e)(transform.y) + ") scale(" + (0, import_index_02532eaa.e)(transform.k) + " " + (0, import_index_02532eaa.e)(transform.k) + ")"}"><title>${(0, import_index_02532eaa.e)(point.id)}</title></circle>`;
  })}</svg>`;
});
let width$7 = 400;
let height$7 = 300;
let margin$5 = 20;
const PolygonBasic = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let xScale;
  let yScale;
  let hull;
  let scaledHull;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", width$7, 0)}${(0, import_index_02532eaa.a)("height", height$7, 0)}>${(0, import_index_02532eaa.b)(data2, (point) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", xScale(point[0]), 0)}${(0, import_index_02532eaa.a)("cy", yScale(point[1]), 0)}${(0, import_index_02532eaa.a)("r", 5, 0)}></circle>`;
  })}<path fill="${"pink"}" fill-opacity="${"0.5"}"${(0, import_index_02532eaa.a)("d", `M${scaledHull.join("L")}Z`, 0)}></path></svg>`;
});
let width$6 = 400;
let height$6 = 300;
let margin$4 = 20;
const PolygonPlus = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let xScale;
  let yScale;
  let hull;
  let scaledHull;
  ...
  return `<p>Polygon area: ${(0, import_index_02532eaa.e)(d3.polygonArea(data2))}</p>
<p>Length of the perimeter: ${(0, import_index_02532eaa.e)(Math.round(d3.polygonLength(data2)))}</p>

<svg${(0, import_index_02532eaa.a)("width", width$6, 0)}${(0, import_index_02532eaa.a)("height", height$6, 0)}>${(0, import_index_02532eaa.b)(data2, (point) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", xScale(point[0]), 0)}${(0, import_index_02532eaa.a)("cy", yScale(point[1]), 0)}${(0, import_index_02532eaa.a)("r", 5, 0)}></circle>`;
  })}<path fill="${"pink"}" fill-opacity="${"0.5"}"${(0, import_index_02532eaa.a)("d", `M${scaledHull.join("L")}Z`, 0)}></path>${(0, import_index_02532eaa.b)(testPoints, (tp) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", xScale(tp[0]), 0)}${(0, import_index_02532eaa.a)("cy", yScale(tp[1]), 0)}${(0, import_index_02532eaa.a)("r", 5, 0)}${(0, import_index_02532eaa.a)("fill", d3.polygonContains(hull, tp) ? "green" : "red", 0)}></circle>
    <text${(0, import_index_02532eaa.a)("x", xScale(tp[0]) + 8, 0)}${(0, import_index_02532eaa.a)("y", yScale(tp[1]), 0)}>${(0, import_index_02532eaa.e)(d3.polygonContains(hull, tp) ? "IN" : "OUT")}</text>`;
  })}<circle${(0, import_index_02532eaa.a)("cx", xScale(centroid[0]), 0)}${(0, import_index_02532eaa.a)("cy", yScale(centroid[1]), 0)}${(0, import_index_02532eaa.a)("r", 5, 0)} fill="${"blue"}"></circle><text${(0, import_index_02532eaa.a)("x", xScale(centroid[0]) + 8, 0)}${(0, import_index_02532eaa.a)("y", yScale(centroid[1]), 0)}>Centroid </text></svg>`;
});
const ShapeArc = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let arcPath;
  const arcGen = d3.arc();
  arcPath = arcGen({
    innerRadius: 0,
  ...
  return `<svg width="${"400"}" height="${"300"}" style="${"padding:30px"}"><path${(0, import_index_02532eaa.a)("d", arcPath, 0)} fill="${"brown"}" style="${"transform:translate(120px,120px)"}"></path></svg>`;
});
const ShapeArea = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let yScale;
  let xScale;
  let area;
  const data2 = [
  ...
  area = areaGen(data2);
  return `<svg width="${"400"}" height="${"300"}"><path${(0, import_index_02532eaa.a)("d", area, 0)} fill="${"pink"}" stroke="${"black"}"></path></svg>`;
});
const ShapeLine = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let yScale;
  let xScale;
  let line;
  let curve;
  ...
  return `<svg width="${"400"}" height="${"300"}"><path${(0, import_index_02532eaa.a)("d", line, 0)} fill="${"none"}" stroke="${"black"}"></path><path${(0, import_index_02532eaa.a)("d", curve, 0)} fill="${"none"}" stroke="${"blue"}"></path></svg>`;
});
const ShapeLinks = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let links;
  ...
  links = linkGen(data2);
  return `
<svg width="${"400"}" height="${"100"}"><path${(0, import_index_02532eaa.a)("d", links, 0)} fill="${"none"}" stroke="${"black"}" stroke-width="${"2"}"></path>${(0, import_index_02532eaa.b)(Object.values(data2), (p) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", p[0], 0)}${(0, import_index_02532eaa.a)("cy", p[1], 0)} r="${"10"}" fill="${"lightblue"}"></circle>`;
  })}</svg>


<svg width="${"400"}" height="${"100"}">${(0, import_index_02532eaa.b)(data22, (dict) => {
    return `${(0, import_index_02532eaa.b)(Object.values(dict), (p) => {
      return `<path${(0, import_index_02532eaa.a)("d", linkGen(dict), 0)} fill="${"none"}" stroke="${"black"}" stroke-width="${"2"}"></path>
      <circle${(0, import_index_02532eaa.a)("cx", p[0], 0)}${(0, import_index_02532eaa.a)("cy", p[1], 0)} r="${"10"}" fill="${"lightblue"}" stroke="${"transparent"}"></circle>`;
    })}`;
  })}</svg>`;
});
const ShapePie = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let arcs;
  let pies;
  ...
  return `
<svg width="${"400"}" height="${"300"}">${(0, import_index_02532eaa.b)(pies, (pie, i) => {
    return `<path${(0, import_index_02532eaa.a)("d", pie, 0)} style="${"transform:translate(150px, 150px)"}"${(0, import_index_02532eaa.a)("fill", d3.schemeCategory10[i], 0)}></path>`;
  })}</svg>`;
});
const fruitData = [
  {
...
let width$5 = 400;
let margin$3 = 40;
const ShapeStack = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let series;
  let yScale;
  let xScale;
  let pinXAxis, pinYAxis;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", width$5, 0)}${(0, import_index_02532eaa.a)("height", height$5, 0)}><g class="${"everything"}" style="${"transform:translate(" + (0, import_index_02532eaa.e)(margin$3) + "px,0)"}"><g class="${"axis axis--x"}"${(0, import_index_02532eaa.a)("this", pinXAxis, 0)}></g><g class="${"axis axis--y"}"${(0, import_index_02532eaa.a)("this", pinYAxis, 0)}></g><g class="${"bars"}" style="${"transform:translate(0," + (0, import_index_02532eaa.e)(margin$3) + "px"}">${(0, import_index_02532eaa.b)(series, (fruit_type, f) => {
    return `<g class="${"ft_" + (0, import_index_02532eaa.e)(fruit_type.key)}">${(0, import_index_02532eaa.b)(fruit_type, (time_period, i) => {
      return `<rect${(0, import_index_02532eaa.a)("x", xScale(`TP${i + 1}`), 0)}${(0, import_index_02532eaa.a)("y", yScale(time_period[1]), 0)}${(0, import_index_02532eaa.a)("width", xScale.bandwidth(), 0)}${(0, import_index_02532eaa.a)("height", yScale(time_period[0]) - yScale(time_period[1]), 0)}${(0, import_index_02532eaa.a)("fill", d3.schemeCategory10[f], 0)}></rect>`;
    })}</g>`;
  })}</g></g></svg>`;
});
const HierarchyPack = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let root;
  let partitionGen;
  let partition;
  let data2 = {
  ...
  return `<svg width="${"260"}" height="${"260"}"><g transform="${"translate(5,5)"}">${(0, import_index_02532eaa.b)(partition.descendants(), (d, i) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", d.x, 0)}${(0, import_index_02532eaa.a)("cy", d.y, 0)}${(0, import_index_02532eaa.a)("r", d.r, 0)} fill="${"green"}"${(0, import_index_02532eaa.a)("fill-opacity", 0.4, 0)}></circle>`;
  })}</g></svg>`;
});
let width$4 = 400;
let height$4 = 300;
let margin$2 = 30;
const HierarchyTree = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let root;
  let treeGen;
  let tree;
  let data2 = {
  ...
  tree = treeGen(root);
  return `<svg${(0, import_index_02532eaa.a)("width", width$4, 0)}${(0, import_index_02532eaa.a)("height", height$4, 0)}><g class="${"everything"}" style="${"transform:translate(0px, 30px"}">${(0, import_index_02532eaa.b)(tree.links(), (link) => {
    return `<line${(0, import_index_02532eaa.a)("x1", link.source.x, 0)}${(0, import_index_02532eaa.a)("x2", link.target.x, 0)}${(0, import_index_02532eaa.a)("y1", link.source.y, 0)}${(0, import_index_02532eaa.a)("y2", link.target.y, 0)} stroke="${"black"}"></line>`;
  })}${(0, import_index_02532eaa.b)(tree.descendants(), (d) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", d.x, 0)}${(0, import_index_02532eaa.a)("cy", d.y, 0)}${(0, import_index_02532eaa.a)("r", 10, 0)} fill="${"lightblue"}"></circle>
      <text${(0, import_index_02532eaa.a)("x", d.x - 5, 0)}${(0, import_index_02532eaa.a)("y", d.y + 5, 0)} fill="${"black"}">${(0, import_index_02532eaa.e)(d.data.name)}</text>`;
  })}</g></svg>`;
});
let width$3 = 400;
let height$3 = 300;
let margin$1 = 30;
const HierarchyCluster = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let root;
  let treeGen;
  let tree;
  let data2 = {
  ...
  tree = treeGen(root);
  return `<svg${(0, import_index_02532eaa.a)("width", width$3, 0)}${(0, import_index_02532eaa.a)("height", height$3, 0)}><g class="${"everything"}" style="${"transform:translate(0px, 30px"}">${(0, import_index_02532eaa.b)(tree.links(), (link) => {
    return `<line${(0, import_index_02532eaa.a)("x1", link.source.x, 0)}${(0, import_index_02532eaa.a)("x2", link.target.x, 0)}${(0, import_index_02532eaa.a)("y1", link.source.y, 0)}${(0, import_index_02532eaa.a)("y2", link.target.y, 0)} stroke="${"black"}"></line>`;
  })}${(0, import_index_02532eaa.b)(tree.descendants(), (d) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", d.x, 0)}${(0, import_index_02532eaa.a)("cy", d.y, 0)}${(0, import_index_02532eaa.a)("r", 10, 0)} fill="${"lightblue"}"></circle>
      <text${(0, import_index_02532eaa.a)("x", d.x - 5, 0)}${(0, import_index_02532eaa.a)("y", d.y + 5, 0)} fill="${"black"}">${(0, import_index_02532eaa.e)(d.data.name)}</text>`;
...
let margin = 30;
let radius = 100;
const HierarchyRadial = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let root;
  let treeGen;
  let tree;
  let lineGen;
  ...
  return `<svg${(0, import_index_02532eaa.a)("width", width$2, 0)}${(0, import_index_02532eaa.a)("height", height$2, 0)}><g class="${"everything"}" transform="${"translate(290,125)"}">${(0, import_index_02532eaa.b)(tree.links(), (link) => {
    return `<path${(0, import_index_02532eaa.a)("d", lineGen([link.target, link.source]), 0)} stroke="${"black"}"></path>`;
  })}${(0, import_index_02532eaa.b)(tree.descendants(), (d) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", 0, 0)}${(0, import_index_02532eaa.a)("cy", d.y, 0)}${(0, import_index_02532eaa.a)("r", 10, 0)} fill="${"lightblue"}" transform="${"rotate(" + (0, import_index_02532eaa.e)(372 - d.x) + ",0,0)"}"></circle>`;
  })}</g></svg>`;
});
...
let width$1 = 400;
let height$1 = 300;
const GeoPath = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let pathGen;
  let path;
  pathGen = d3.geoPath();
  path = pathGen(walesData);
  return `<svg viewBox="${"93,149,10,12"}"${(0, import_index_02532eaa.a)("width", width$1, 0)}${(0, import_index_02532eaa.a)("height", height$1, 0)}><path${(0, import_index_02532eaa.a)("d", path, 0)} transform="${"translate(100,100)"}" fill="${"lightblue"}" stroke="${"darkgray"}" stroke-width="${"0.05"}"></path></svg>`;
});
...
let height = 300;
let numPoints = 100;
const ZoomBasic = (0, import_index_02532eaa.c)(($$result, $$props, $$bindings, slots) => {
  let data2;
...
<svg${(0, import_index_02532eaa.a)("width", width, 0)}${(0, import_index_02532eaa.a)("height", height, 0)} class="${"svelte-ndpz51"}"${(0, import_index_02532eaa.a)("this", bindInitZoom, 0)}><g class="${"points"}"${(0, import_index_02532eaa.a)("this", bindHandleZoom, 0)}>${(0, import_index_02532eaa.b)(data2, (d, i) => {
    return `<circle${(0, import_index_02532eaa.a)("cx", d.x, 0)}${(0, import_index_02532eaa.a)("cy", d.y, 0)} r="${"4"}"${(0, import_index_02532eaa.a)("fill", d3.interpolateBlues(30 / (i + 1)), 0)}></circle>`;
  })}</g></svg>`;
});
