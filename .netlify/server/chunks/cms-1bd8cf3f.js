import { d as d3CMS, a as d3Charts, c as cmsSvelte, r as readable } from "./cms-svelte-147b3ebc.js";
...
const charts = d3Charts.filter((records) => records.published).map((post) => {
  return {
    id: post.primary_key,
    cat: "D3 Charts",
    thumbnail: post.thumbnail,
...
const svelteArticles = cmsSvelte.filter((records) => records.published).map((post) => {
  return {
    id: post.primary_key,
    cat: "Svelte",
    thumbnail: post.thumbnail,
