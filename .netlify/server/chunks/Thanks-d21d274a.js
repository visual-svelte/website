...
import { s as scrollY, K as Kofi } from "./screen-6364735e.js";
import { b as allLight } from "./cms-86c250c1.js";
import { k as keyToSentence } from "./textUtils-217980c7.js";
...
const css = {
  code: ":root{--z-bottom:-100;--z-middle:0;--z-top:100;--z-overlay:1000;--border-radius:4px;--font-body:var(--serif);--font-form:var(--serif);--color-bg:#ffffff;--color-fg:var(--color-off-black);--color-placeholder:var(--color-gray-dark);--color-link:var(--color-purple);--color-focus:transparent;--color-form-bg:var(--color-gray-dark);--color-form-fg:var(--color-off-black);--color-border:var(--color-gray-light);--color-selection:var(--color-gray-light);--color-highlight:var(--color-yellow);--white:#ffffff;--off-white:#f3f3f3;--dragon:#b40d61;--lemon:#f7c419;--berry:#fb3636;--dark:#1e1d1d;--c-white:#fff;--c-gray:#dfdfdf;--c-green:#77e323;--c-darkgray:#42453d;--c-black:#000000;--c-green-15:rgba(119, 227, 35, 0.15)}.wrapper.svelte-vyud5d.svelte-vyud5d{max-width:600px;margin:100px autoc 0;padding-bottom:50px}.kofi-cup.svelte-vyud5d.svelte-vyud5d{margin:20px;display:inline-block}.sorting.svelte-vyud5d span.svelte-vyud5d{cursor:pointer;margin:0px 10px;user-select:none}.list-container.svelte-vyud5d.svelte-vyud5d{display:flex;flex-wrap:wrap;gap:1rem;margin:0 auto;max-width:1000px}.list-container.svelte-vyud5d a.svelte-vyud5d{padding:10px 20px;transition:0.3 all;text-decoration:none}.list-container.svelte-vyud5d a.svelte-vyud5d:hover{text-decoration:underline;background-color:rgba(243, 243, 243, 0.1)}",
  map: null
};
...
const Thanks = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"wrapper svelte-vyud5d"}"><h2>Thanks for viewing!</h2>
  ...
  <div class="${"kofi-cup svelte-vyud5d"}">${validate_component(Kofi, "Kofi").$$render($$result, {}, {}, {})}</div>

  <h2>Pick your next article</h2>

  <p class="${"sorting svelte-vyud5d"}">Sort:<span class="${"svelte-vyud5d"}">A-&gt;Z</span>
    </p>
  <div class="${"list-container svelte-vyud5d"}">${each(articles, (a) => {
    return `<a${add_attribute("href", a.href, 0)} rel="${"internal"}" style="${escape(a.cat == "D3 API" ? "border-top:3px solid var(--berry); background-color: rgba(251,54,54,0.2); " : a.cat == "D3 Charts" ? "border-top:3px solid var(--dragon); background-color: rgba(180,13,97,0.2);" : "border-top:3px solid var(--lemon); background-color: rgba(247,196,25,0.2);") + ""}" class="${"svelte-vyud5d"}">${escape(keyToSentence(a.id))}
      </a>`;
  })}</div>
</div>`;
});
