...
function density_default() {
  var x = defaultX, y = defaultY, weight = defaultWeight, dx = 960, dy = 500, r = 20, k = 2, o = r * 3, n = dx + o * 2 >> k, m = dy + o * 2 >> k, threshold2 = constant_default2(20);
  ...
  density.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : constant_default2(+_), density) : x;
  };
  density.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : constant_default2(+_), density) : y;
  };
...
var int_default = function sourceRandomInt(source) {
  function randomInt(min2, max3) {
    if (arguments.length < 2)
      max3 = min2, min2 = 0;
    min2 = Math.floor(min2);
    max3 = Math.floor(max3) - min2;
    return function() {
      return Math.floor(source() * max3 + min2);
    };
  }
